...
export function PlaywireContainer(props: IProps) {
  ...
  if (props.enableBottomRail) pwUnits.push({ type: "bottom_rail" });

  if (props.enableTrendiVideo) pwUnits.push({ type: "trendi_video" });
  ...
  useEffect(() => {
    ...
    const init = () => {
      if (typeof window !== "undefined") console.log("[Playwire] Initialized");
      else console.log("[Playwire] Unable to initialize");
